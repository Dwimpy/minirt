...
/*   Updated: 2023/05/04 17:05:07 by arobu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "transform.h"

t_transform	inline	new_transform_rotate_x(double radians)
{
...
t_transform inline	new_transform_rotate_y(double radians)
{
	t_transform	transform;
	double		cosine;
	double		sine;
...
t_transform inline	new_transform_rotate_z(double radians)
{
	t_transform	transform;
	double		cosine;
	double		sine;
...
void inline	transform_vector(t_vec3	*vec, t_mat4x4 tf)
{
	t_vec3	tmp;
