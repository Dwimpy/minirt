...
/*   Updated: 2023/07/11 13:40:47 by arobu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "rect.h"

t_shapes rect_get_name_override(t_shape *self) { return ((t_shapes) RECT); }
...
t_shape *rect_to_shape(t_rect *rect) { return ((t_shape *) rect); }
