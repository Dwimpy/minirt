...
/*   Updated: 2023/07/02 20:35:44 by arobu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef bool (*t_scatter)(t_scatter_params params, t_sampler *sampler);

typedef enum mat_type { LAMBERTIAN, GLASS, METAL } t_mat_type;
