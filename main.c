...
/*   Updated: 2023/05/22 20:03:03 by arobu            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	// set_vec_comp(&sphere2.center, 2.0f, 0.0f, 5.0f);

	sphere = create_sphere(0.5, (t_vec3){1.0f, 1.0f, 5.0f});
	// set_vec_comp(&sphere->data->center, 0.0f, 0.0f, 5.0f);
	// sphere->data->radius = 0.5;
	...
	transform_vector(&sphere->data->center, camera.transformation.mat);
	
	// transform_point(&sphere->center, tf_translate(0.0f, 0.0f, -10.f).mat);
	// transform_point(&sphere->center, tf_translate(0.4f, 0.4f, +1.0f).mat);
	// printf("%f", sphere->data->radius);
	// printf("%d:", sphere->shape.shape_info->name(&sphere->shape));
	// printf("%f\n", sphere->data->center.x);
